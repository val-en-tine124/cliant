...
mod tests {
    ...
    fn test_split_parts_more_concurrent_than_ideal() {
        ...
        assert_eq!(parts[0], vec![0, 1 * 1024 * 1024 - 1]);
        assert_eq!(parts[9], vec![9 * 1024 * 1024, 10 * 1024 * 1024 - 1]);
    }
    ...
    fn test_split_parts_fewer_concurrent_than_ideal() {
        ...
        assert_eq!(parts[0], vec![0, 20 * 1024 * 1024 - 1]);
        assert_eq!(parts[4], vec![80 * 1024 * 1024, 100 * 1024 * 1024 - 1]);
    }
    ...
    fn test_split_parts_single_part_due_to_max_concurrent() {
        ...
        assert_eq!(parts[0], vec![0, 100 * 1024 * 1024 - 1]);
    }
}
